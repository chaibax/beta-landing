        ...
        <div class="fr-grid-row fr-grid-row--gutters">
          <div class="fr-col">
            ...
            <p>
              ...
              <b>non conforme avec le RGAA 4.0</b> : le site n'a pas encore été
              audité.
            </p>

            <p>
              Nous souhaitons cependant qu'il soit accessible au plus grand
              nombre. Vous devriez donc pouvoir :
            </p>
            <ul>
              <li>
            ...
            <ul>
              ...
              <li>
                Certains documents sont hébergés sur Google Drive. Nous ne
                garantissons par leur accessibilité, mais essayons de fournir un
                support texte à toutes nos formations et interventions.
              </li>
            </ul>

            <p>
              <a class="fr-btn fr-btn--sm" href="/statement"
                >Lire la déclaration d'accessibilité</a
              >
            </p>
          </div>
        </div>
